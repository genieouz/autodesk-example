...
Autodesk.Research.TtIf.Extension.Toolbar = function (viewer, options) {
  ...
  function createToolbar() {
    ...
    var names = ['Style', 'Text', 'Circle', 'Rectangle', 'Cloud', 'Arrow', 'Freehand', 'Polyline', 'Polycloud','Annotation', 'Save', 'Exit'];

   // var icons = ['dashboard', 'fire', 'flash', 'dashboard', 'fire', 'flash', 'dashboard', 'fire', 'flash'];

    var tips = ['Style', 'Texte', 'Cercle', 'Rectangle', 'Nuage', 'Flèche', 'Dessin', 'Polyligne', 'Polynuage','Annotation', 'Enregistrer', 'Quitter'];
